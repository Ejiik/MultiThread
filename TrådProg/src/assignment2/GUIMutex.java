 ...
 */
public class GUIMutex implements ActionListener, ItemListener{
	/**
	 ...
	 * Constructor
	 */
	public GUIMutex(Writer writer, CharacterBuffer charBuffer){
		this.writer = writer;
	...
	private void InitializeGUI()
	{
		...
		bSync.addItemListener(this);
		bAsync.addItemListener(this);
		btnRun.addActionListener(this);
		btnClear.addActionListener(this);
	}

	public void transDone(){
		btnRun.setEnabled(true);
		pnlRes.setBackground(Color.RED);
		lblStatus.setText("Ready for input");
		listR.setText(listR.getText() + "Recieved: " + recText + "\n");
	}
	
	public void addReadText(String text){
		lblRec.setText(text);
		recText = text;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnRun){
			textToSend = txtTrans.getText();
			if(textToSend != ""){
				btnRun.setEnabled(false);
				writer.newString(textToSend);
				writer.startWrite();
				btnClear.setEnabled(true);
				pnlRes.setBackground(Color.GREEN);
				lblStatus.setText("Transferring");
				lblTrans.setText(textToSend);
				listW.setText(listW.getText() + "Transferred: " + textToSend + "\n");
